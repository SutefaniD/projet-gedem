...
--
-- Hôte : localhost:3306
-- Généré le : dim. 07 mai 2023 à 11:19
...
CREATE TABLE `df_formateur_formation` (
  `idFormateur_Fomation` int(11) UNSIGNED NOT NULL,
  `idFormateur` int(11) UNSIGNED DEFAULT NULL,
  `idFormation` int(11) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `df_formateur_matiere` (
  `idFormateur_Matiere` int(11) UNSIGNED NOT NULL,
  `idFormateur` int(11) UNSIGNED DEFAULT NULL,
  `idMatiere` int(11) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `df_stagiaire_formation` (
  ...
  `idStagiaire` int(11) UNSIGNED DEFAULT NULL,
  `idFormation` int(11) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `h_personne_administratif` (
  `idAdministratif` int(11) UNSIGNED NOT NULL,
  `idPersonne` int(11) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `h_signatureformateur` (
  `idSignatureFormateur` int(11) UNSIGNED NOT NULL,
  `idSignatureStagiaire` int(11) UNSIGNED DEFAULT NULL,
  `idFormateur_Formation` int(11) UNSIGNED DEFAULT NULL,
...
INSERT INTO `personne` (`idPersonne`, `idRole`, `nom`, `prenom`, `mail`, `tel`, `login`, `password`) VALUES
(1, 1, 'Calment', 'Jeanne', 'jeanne.calment@free.fr', '0234627312', 'jcalment', 'jcalment'),
(2, 2, 'Gilmour', 'David', 'd.gilmour@darkside.uk', '0433768562', 'dgilmour', 'dgilmour'),
(3, 1, 'Tanaka', 'Kane', 'kane.tanaka@orange.fr', '0134327313', 'ktanaka', 'ktanaka'),
(4, 3, 'Knauss', 'Sarah', 'sarah.knauss@yahoo.fr', '0234627312', 'sknauss', 'sknauss'),
(5, 2, 'Beard', 'Mathew', 'mat.b@gmail.com', '0234627241', 'mbeard', 'mbeard'),
(6, 2, 'Richard', 'Pierre', 'pierre.richard@free.fr', '013462737', 'prichard', 'prichard'),
(7, 3, 'Weasley', 'Ginny', 'g.weasley@poudlard.com', NULL, 'gweasley', 'gweasley'),
(8, 2, 'Sand', 'George', 'g.sand@free.fr', NULL, 'gsand', 'gsand'),
(9, 2, 'Dalle', 'Béatrice', 'b.dalle@yahoo.bzh', NULL, 'bdalle', 'bdalle'),
(10, 2, 'de Gouges', 'Olympes', 'o.degrouges@free.fr', NULL, 'odegouges', 'odegouges'),
(11, 3, 'Potter', 'Harry', 'h.potter@poudlard.com', NULL, 'hpotter', 'hpotter'),
(12, 3, 'Weasley', 'Ron', 'ronaldb.weasley@poudlard.com', NULL, 'ronweasley', 'rweasley'),
(13, 3, 'Granger', 'Hermione', 'h.granger@poudlard.com', NULL, 'hgranger', 'hgranger'),
(14, 1, 'ad', 'min', 'admin@yaho.bzh', NULL, 'admin', 'admin'),
(15, 2, 'form', 'ateur', 'form@yahoo.com', NULL, 'formateur', 'formateur'),
(16, 3, 'sta', 'giaire', '', NULL, 'stagiaire', 'stagiaire');
...
CREATE TABLE `signaturestagiaire` (
  ...
  `idStagiaire_Formation` int(11) UNSIGNED DEFAULT NULL,
  `idCreneau` int(11) UNSIGNED DEFAULT NULL,
...
--
ALTER TABLE `creneau`
  MODIFY `idCreneau` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `df_formateur_formation`
--
ALTER TABLE `df_formateur_formation`
  MODIFY `idFormateur_Fomation` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `df_formateur_matiere`
--
ALTER TABLE `df_formateur_matiere`
  MODIFY `idFormateur_Matiere` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `df_matiere_formation`
--
ALTER TABLE `df_matiere_formation`
  MODIFY `idMatiere_Formation` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `df_stagiaire_formation`
--
ALTER TABLE `df_stagiaire_formation`
  MODIFY `idStagiaire_Formation` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `formation`
--
ALTER TABLE `formation`
  MODIFY `idFormation` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `h_personne_administratif`
--
ALTER TABLE `h_personne_administratif`
  MODIFY `idAdministratif` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `h_personne_formateur`
--
ALTER TABLE `h_personne_formateur`
  MODIFY `idFormateur` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `h_personne_stagiaire`
--
ALTER TABLE `h_personne_stagiaire`
  MODIFY `idStagiaire` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `h_signatureformateur`
--
ALTER TABLE `h_signatureformateur`
  MODIFY `idSignatureFormateur` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `matiere`
--
ALTER TABLE `matiere`
  MODIFY `idMatiere` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `personne`
--
ALTER TABLE `personne`
  MODIFY `idPersonne` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT pour la table `role`
--
ALTER TABLE `role`
  MODIFY `idRole` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
