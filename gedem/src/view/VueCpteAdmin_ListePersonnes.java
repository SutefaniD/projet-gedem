...
public class VueCpteAdmin_ListePersonnes extends JPanel {
	private App app;
	...
	private VueListePersonnes vlp;

	/**
	 * CONSTRUCTEUR
	 * @param appli
	 */
	public VueCpteAdmin_ListePersonnes () {
		//this.app = appli;
		...
		this.label.setText("Liste des Personnes");
