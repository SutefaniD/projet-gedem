...
public class ControleurStagiaire {
	...
	// récupérer table stagiaires
	public ControleurStagiaire() {
		
		this.acces = new ControlConnection();
	...
	public String listerStagiaireStr() { 
		...
		try {
			...
			if (!acces.getConn().isClosed()) {
				...
				ControlConnection cc4 = new ControlConnection();
			...
			acces.fermerConn(); // appel de la prodédure de ControlConnection qui ferme la connexion
		}
		catch (SQLException efc){
