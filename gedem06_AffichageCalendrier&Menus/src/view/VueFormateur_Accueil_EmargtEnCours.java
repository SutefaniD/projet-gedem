...
public class VueFormateur_Accueil_EmargtEnCours extends JPanel {
	...
	public VueFormateur_Accueil_EmargtEnCours (App appli) {		
    
			// Barre de menu dans la frame
			appli.setJMenuBar(new VueForm_MenuBarre(appli));
