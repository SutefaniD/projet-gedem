...
public class VueStagiaire_Accueil_EmargtEnCours extends JMenuBar {
	 ...
	 * Constructeur
	 */
	public VueStagiaire_Accueil_EmargtEnCours(App appli) {
		
		// Barre de menu dans la frame
		appli.setJMenuBar(new VueStg_MenuBarre(appli));
		
		//ControleurStagiaire cs1 = new ControleurStagiaire();
		//String resultat = cs1.listerStagiaireStr();
		//zoneTexte = new JTextArea(resultat);
		//this.texte = new JTextField("Bienvenue " +prenom +" " +nom +"!");
